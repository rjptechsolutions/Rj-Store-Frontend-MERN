...
const Card = ({
  ...
  const cartTitle = product ? product.name : "It's Sample";

  const cartDescription = product
    ? product.description
    : 'Not For Sale, similar products for upcoming sales';

  const cartPrice = product ? product.price : 'Not For Sale';
  ...
  return (
    <div className="card text-white bg-dark border border-info ">
      ...
      <div className="card-body">
        {' '}
        {getRedirect(redirect)} <ImageHelper product={product} />{' '}
